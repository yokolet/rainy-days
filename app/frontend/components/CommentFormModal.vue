...
const props = defineProps<{ isOpen: boolean, postId: string, replyId: string | null }>()
const emit = defineEmits(['close'])

const { body, commentCreate, commentCreateLoading, commentCreateError,} = useCommentCreate(props.postId, props.replyId)
